...
import 'package:book_balance/page/supplier_transaction_page.dart';
...
class _SupplierDetailScreenState extends State<SupplierDetailScreen> {
  ...
  void updateTotalDue() {
    ...
    controller.updateSupplier(widget.index, {
      'name': widget.title,
    ...
    controller.supplierTransaction(widget.index, {
      'title': widget.title,
      'totalDue': totalDue,
          ...
          PopupMenuButton(
            itemBuilder: (context) => [
              PopupMenuItem(
                ...
                onTap: () {
                  Get.to(() => SupplierTransactionPage(supplierIndex: widget.index));
                },
              ),
              PopupMenuItem(
                child: const Row(
